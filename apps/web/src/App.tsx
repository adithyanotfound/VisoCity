      ...
      socket.onmessage = (event) => {
        try {
          ...
          if (msg.type === 'cities.roster') {
            setMessages((prev) => [
              ...prev,
              `ROSTER: Discovered ${msg.cities.length} city sector(s).`,
            ]);
    ...
    <div style={{ height: '100vh', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          ...
          <div
            className={`badge ${wsStatus === 'connected' ? 'badge-success' : wsStatus === 'connecting' ? 'badge-warning' : 'badge-error'}`}
          >
            <span
              className={`pulse-dot ${wsStatus === 'connected' ? 'pulse-dot-green' : wsStatus === 'connecting' ? 'pulse-dot-amber' : 'pulse-dot-red'}`}
            />
      ...
      <main style={{ flex: 1, position: 'relative', display: 'flex', overflow: 'hidden' }}>
          ...
          >
            ...
            <div>
              <h2 style={{ fontSize: '18px', fontWeight: 700, marginBottom: '6px' }}>
                Isometric Spatial Canvas Shell
              </h2>
              <p style={{ fontSize: '13px', color: 'var(--text-secondary)', lineHeight: '1.5' }}>
                Phaser 3 isometric engine and block-treemap world generator will project repo files
                as 3D isometric structures.
              </p>
            </div>
        ...
        >
          ...
          <div
            className="panel"
            style={{ display: 'flex', flexDirection: 'column', maxHeight: '320px' }}
          >
          ...
          <div className="panel">
            ...
            >
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                ...
                <span
                  style={{ display: 'flex', alignItems: 'center', gap: '4px', color: '#38bdf8' }}
                >
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                ...
                >
                  ...
                  <select
                    value={specialist}
                    onChange={(e) =>
                      setSpecialist(e.target.value as 'worker' | 'architect' | 'runner')
                    }
                    style={{
                  ...
                  >
                    <option value="worker" style={{ background: '#18181b' }}>
                      Worker (Sonnet)
                    </option>
                    <option value="architect" style={{ background: '#18181b' }}>
                      Architect (Opus)
                    </option>
                    <option value="runner" style={{ background: '#18181b' }}>
                      Runner (Haiku)
                    </option>
                  </select>
                </div>
                ...
                >
                  ...
                  >
                    <option value="low" style={{ background: '#18181b' }}>
                      Low Effort
                    </option>
                    <option value="medium" style={{ background: '#18181b' }}>
                      Medium Effort
                    </option>
                    <option value="high" style={{ background: '#18181b' }}>
                      High Effort
                    </option>
                    <option value="max" style={{ background: '#18181b' }}>
                      Max Effort
                    </option>
                  </select>
                </div>
